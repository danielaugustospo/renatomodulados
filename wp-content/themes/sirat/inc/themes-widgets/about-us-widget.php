...
class Sirat_About_Widget extends WP_Widget {
	function __construct() {
		parent::__construct(
			'Sirat_About_Widget',
			__('VW About us', 'sirat'),
			array( 'description' => __( 'Widget for about us section in sidebar', 'sirat' ), ) 
		);
	}
	...
	public function form( $instance ) {
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('author')); ?>"><?php esc_html_e('Author Name:','sirat'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('designation')); ?>"><?php esc_html_e('Designation:','sirat'); ?></label>
    	...
    	<p>
        <label for="<?php echo esc_attr($this->get_field_id('description')); ?>"><?php esc_html_e('Description:','sirat'); ?></label>
    	...
    	<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_text')); ?>"><?php esc_html_e('Button Text:','sirat'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id('read_more_url')); ?>"><?php esc_html_e('Button Url:','sirat'); ?></label>
		...
		<p>
		<label for="<?php echo esc_attr($this->get_field_id( 'upload_image' )); ?>"><?php esc_html_e( 'Image Url:','sirat'); ?></label>
		<?php
			if ( $upload_image != '' ) :
...
function sirat_about_custom_load_widget() {
	register_widget( 'Sirat_About_Widget' );
}
add_action( 'widgets_init', 'sirat_about_custom_load_widget' );