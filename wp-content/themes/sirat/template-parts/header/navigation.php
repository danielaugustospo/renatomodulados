...
<div class="menubar">
	<div class="toggle-nav mobile-menu">
	    <button onclick="sirat_menu_open_nav()" class="responsivetoggle"><i class="<?php echo esc_attr(get_theme_mod('sirat_res_menus_open_icon','fas fa-bars')); ?>"></i><span class="screen-reader-text"><?php esc_html_e('Open Button','sirat'); ?></span></button>
	</div>
